...
public class DindySingleProfileAppWidgetConfigure extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		DindySingleProfileAppWidgetConfigure.this.startActivityForResult(
				profilesListIntent, PROFILE_SELECT_REQUEST_CODE);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		DindySettings.WidgetSettings widgetSettings = new DindySettings.WidgetSettings();
		...
		prefs.setWidgetSettings(widgetPreferences, mAppWidgetId, widgetSettings);

		AppWidgetManager appWidgetManager = AppWidgetManager
				.getInstance(getApplicationContext());
		DindySingleProfileAppWidgetProvider.updateOneSingleProfileWidget(
				getApplicationContext(), appWidgetManager, getPackageName(),
				prefs, widgetSettings, mAppWidgetId,
